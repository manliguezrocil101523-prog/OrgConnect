...
class WelcomePage extends StatelessWidget {
  // Define the WelcomePage class extending StatelessWidget for a static welcome screen in the organization management app
  const WelcomePage(
      {super.key}); // Constructor for WelcomePage with optional key parameter for widget identification
  @override // Override the build method from StatelessWidget to define the UI
  Widget build(BuildContext context) {
    // Build method that constructs the welcome page widget tree
    const darkGreen = Color(
        0xFF496E68); // Define a constant color for the dark green theme used in the welcome page
    return Scaffold(
      // Return a Scaffold widget as the root of the welcome page layout
      body: Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(
                    height: 60), // Add vertical space of 60 pixels at the top
                Container(
                  ...
                  child: Center(
                    ...
                    child: Image.asset(
                      // Display the app logo using an asset image
                      'assets/orgconnectLogo.jpg', // Path to the logo asset
                      fit: BoxFit
                          .contain, // Fit the image to contain within the bounds
                    ),
                  ),
                ),
                const SizedBox(
                    height:
                        40), // Add vertical space of 40 pixels below the logo
                const Text(
                ...
                Text(
                  // Display the welcome message text
                  ...
                  style: TextStyle(
                    ...
                    color: darkGreen.withValues(
                        alpha: 0.85), // Dark green with 85% opacity
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    // Create an elevated button for getting started
                    onPressed: () => Navigator.pushReplacementNamed(context,
                        '/home'), // On press, navigate to home screen replacing current
