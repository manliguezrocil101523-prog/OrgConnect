...
class AdminDashboard extends StatelessWidget {
  // Define the AdminDashboard class extending StatelessWidget for a static dashboard screen for admin role in the organization management system
  const AdminDashboard(
      {super.key}); // Constructor for AdminDashboard with optional key parameter for widget identification
  ...
  Widget build(BuildContext context) {
    // Build method that constructs the widget tree for the admin dashboard screen
    return Scaffold(
      ...
      body: Padding(
        ...
        padding:
            const EdgeInsets.all(20.0), // Set padding of 20 pixels on all sides
        child: Center(
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                _tile(
                  // Call the helper method to create a tile button
                  ...
                  () => Navigator.push(
                    // Define the onTap callback to navigate
                    context, // BuildContext
                    MaterialPageRoute(
                        builder: (_) =>
                            const AdminAccountsScreen()), // MaterialPageRoute to admin accounts screen
                  ),
                ),
                const SizedBox(height: 14), // Add vertical space of 14 pixels
                _tile(
                  // Call the helper method for manage organizations tile
                  context,
                  'Manage Organizations',
                  Icons.apartment_outlined,
                  () => Navigator.push(
                    // Navigate to admin organizations screen
                    context,
                    MaterialPageRoute(
  ...
  Widget _tile(
    ...
    // Define a private helper method to create tile buttons
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          ...
          padding: const EdgeInsets.symmetric(
              vertical: 16, horizontal: 16), // Set padding
          shape: RoundedRectangleBorder(
              borderRadius:
                  BorderRadius.circular(28)), // Set shape to rounded rectangle
        ),
        ...
        label: Text(
          ...
          style: const TextStyle(
              ...
              letterSpacing: 1.1), // Style the text
        ),
      ),
    );
  }
